    ...
    return (
        <div className="flex flex-col justify-center mx-auto pt-[125px] pb-10">
            ...
            <div className="container mx-auto flex items-start font-classic animate-appear mt-10">
                <img className="max-h-[200px] w-auto rounded-full mt-5 mr-5" src={francineShapiro} alt="Francine Shapiro, emdr"/>
                <div className="px-5 flex flex-col justify-center">
                    ...
                    <p className="pb-3 sm:text-lg 2xl:text-xl">
                        L’EMDR a un nom et visage : celui d’une américaine prénommé <a className="underline"
                    ...
                    <p className="pb-3 sm:text-lg 2xl:text-xl">
                        ...
                        scientifiques internationales ces dernières années. <span className="font-semibold"> <br/>
                        ...
                        Autorité de la Santé (2007)</span>.
                    </p>
                    <p className="pb-3 sm:text-lg 2xl:text-xl">
