    ...
    return (
        <div className="flex flex-col justify-center mx-auto pt-[125px] pb-10 mb-10">
            <div className="flex h-[300px] items-center font-classic overflow-hidden bg-orangePale mb-10 relative -z-10">
                ...
                <img
                    className="w-1/2 min-w-[320px] h-auto object-cover"
                    src={EMDRYeux}
                    alt="visage en gros plan avec deux doigts levés devant nous"/>
                <div className="w-1/2 px-5 flex flex-col">
                    <h3 className=" py-5 pb-5 text-xl text-bleu font-semibold">EMDR : qu’est-ce que cela veut dire ?<br/>
                        <span className="font-normal">L’EMDR : une
                        thérapie par les yeux.</span>
                    </h3>
                    <p className="pb-3 text-xl"><span className="italic">E. M. D. R : Eye Movement Desensitization and Reprocessing</span>,
                        soit
                        désensibilisation et reprogrammation par mouvements oculaires. </p>
                    <p className="pb-3 text-xl">
                        Je sais on avait dit que l’on
                        allait faire simple… Alors essayons ceci : bouger les yeux pour aller mieux ? EMDR : guérir à
                        vue
                        d’œil ?
            ...
            <div className="container mx-auto flex font-classic animate-appear mt-10">
                <div className="px-5 flex flex-col justify-center">
                    <h3 className=" py-5 pb-5 text-3xl text-bleu font-title font-semibold">L’EMDR est-ce simplement bouger les yeux pour aller mieux
                        ?</h3>
                    ...
                    <figure className="sm:w-1/2 mx-auto my-8">
                        <blockquote>
                            <p className="sm:text-lg 2xl:text-xl">
                                Mais que les choses soient claires: la thérapie EMDR va bien au-delà des simples mouvements oculaires. Elle inclut des procédures et des protocoles uniques à cette thérapie. C’est une combinaison, une interaction de ces procédures et des stimulations bilatérales qui assure le traitement. Le plus troublant, c’est qu’on en est réduit au stade des conjectures pour expliquer ses mécanismes.
                            </p>
                        </blockquote>
                    ...
                    <p className="pb-3 sm:text-lg 2xl:text-xl">
                        Comment bouger les yeux de droite à gauche et de gauche à droite peut-il aider à surmonter son anxiété, voire un traumatisme ?
